...
function submitUserData(e) {
    ...
    axios.post("https://crudcrud.com/api/bb37140fe0464c36bb065efe47ca864c/AppointmentData", userData)
        .then((response) => {
...
function deleteUser(event) {
    ...
    axios.delete(`https://crudcrud.com/api/bb37140fe0464c36bb065efe47ca864c/AppointmentData/${userID}`)
        .then(() => {
            li.remove();
        })
        .catch((error) => {
...
function editdetails(event) {
    ...
    axios.get(`https://crudcrud.com/api/bb37140fe0464c36bb065efe47ca864c/AppointmentData/${userID}`)
        .then((response) => {
...
function fetchAppointmentData() {
    axios.get("https://crudcrud.com/api/bb37140fe0464c36bb065efe47ca864c/AppointmentData")
        .then((response) => {
